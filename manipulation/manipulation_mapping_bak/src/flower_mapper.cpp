                   ...
                   manipulation_common::UpdateFlowerMap::Response &res)
{
        ...
        for(int i=0; i<req.poses.size(); i++)
        {
                ...
                std::cout << "pc_.data.size() = " << pc_.data.size() << std::endl;
                std::cout << "3" << std::endl;
        ...
        res.status = 1;
        std::cout << "update flower map complete." << std::endl;
        return true;
}
...
gtsam::Point3 FlowerMapper::get_pc_norm_vec(sensor_msgs::PointCloud2 pc)
{
        ...
        std::cout << "estimator_type = " << estimator_type << std::endl;
        ...
        switch (estimator_type)
        {
            case 0:
            {
                    ...
                    std::cout << "get coefficients1" << std::endl;
                    sac.getModelCoefficients (coeff);
                    std::cout << "get coefficients2" << std::endl;
